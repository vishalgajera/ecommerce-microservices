...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<RestResponse> outOfStockException(final OutOfStockException outOfStockException) throws IOException {
        LOGGER.error("+++++++++++++++++ OutOfStockException +++++++++++++++");
        String actualFailureMsg = outOfStockException.getMessage();
        RestResponse restExchangeResponse = prepareRestResponse(actualFailureMsg);
        ResponseEntity<RestResponse> returnOutput = new ResponseEntity<>(restExchangeResponse, HttpStatus.BAD_REQUEST);
        LOGGER.error("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        LOGGER.error(actualFailureMsg);
        LOGGER.error("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        LOGGER.error(ExceptionUtils.getStackTrace(outOfStockException));
